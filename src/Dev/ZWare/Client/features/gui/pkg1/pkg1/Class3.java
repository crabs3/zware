...
public class Class3 extends Class11 {
   ...
   private static final int field_1085 = 2;
   // $VF: renamed from: o int
   private static final int field_1086 = 14;
   // $VF: renamed from: p int
   private static final int field_1087 = 14;
   // $VF: renamed from: q int
   private static final int field_1088 = 18;
   // $VF: renamed from: r int
   private static final int field_1089 = 4;
   // $VF: renamed from: s int
   private static final int field_1090 = 4;
   // $VF: renamed from: t java.util.List
   private static final List<Item> field_1091 = method_1754();
   // $VF: renamed from: u Dev.ZWare.Client.features.pkg3.Class1
   private final Dev.ZWare.Client.features.pkg3.Class1 field_1092;
   // $VF: renamed from: v boolean
   private boolean field_1093;
   // $VF: renamed from: w boolean
   private boolean field_1094;
   // $VF: renamed from: x java.lang.String
   private String field_1095 = "";
   // $VF: renamed from: y int
   private int field_1096;
   // $VF: renamed from: z net.minecraft.item.Item
   private Item field_1097;

   public Class3(Dev.ZWare.Client.features.pkg3.Class1 setting) {
      super(setting.a());
      this.field_1092 = setting;
      this.i = 15;
   }
   ...
   public void method_1701(DrawContext context, int mouseX, int mouseY, float partialTicks) {
      ...
      this.field_1097 = null;
      int var5 = Math.round(this.c());
      int var6 = Math.round(this.d());
      this.a(context, this.c(this.method_1743(mouseX, mouseY)));
      String var7 = this.a(this.field_1092.a() + " " + Formatting.field_1080 + this.method_1750(), Math.max(16, this.a() - 6));
      this.a(var7, -1);
      if (this.field_1093) {
         int var8 = this.method_1749();
         int var9 = Math.round(this.h + this.d() + 1.0F);
         int var10 = this.method_1748();
         ...
         String var14 = this.field_1095.isEmpty() && !this.field_1094 ? "*" : this.field_1095 + (this.field_1094 ? Class6.method_1819() : "");
         ...
         List var16 = this.method_1746();
         int var17 = this.method_1747();
         int var18 = var17 * 4;
         int var19 = Math.max(1, (int)Math.ceil((double)var16.size() / Math.max(1, var18)));
         this.field_1096 = Math.max(0, Math.min(this.field_1096, var19 - 1));
         int var20 = var13 + 2;
         int var21 = var20 + 72;
         ...
         int var22 = this.field_1096 * var18;
         ...
         for (int var24 = var22; var24 < var23; var24++) {
            ...
            Item var32 = (Item)var16.get(var24);
            boolean var33 = this.field_1092.method_711(var32);
            boolean var34 = this.method_1753(mouseX, mouseY, var28, var29, var30, var31);
            ...
            context.method_51427(new ItemStack(var32), var28 + 1, var29 + 1);
            if (var34) {
               this.field_1097 = var32;
            }
         }
         ...
         int var43 = var11 - 1;
         boolean var44 = this.method_1753(mouseX, mouseY, var40, var37 + 1, var41, var38 - 1);
         boolean var45 = this.method_1753(mouseX, mouseY, var42, var37 + 1, var43, var38 - 1);
         ...
         String var46 = this.field_1096 + 1 + "/" + var19;
         ...
         if (this.field_1097 != null) {
            context.method_51434(
               c.field_1772,
               List.of(this.field_1097.method_63680(), Text.method_43470(this.method_1751(this.field_1097)).method_27692(Formatting.field_1080)),
               mouseX,
               mouseY
            );
         }
   ...
   public void method_1702(int mouseX, int mouseY, int mouseButton) {
      if (this.method_1743(mouseX, mouseY)) {
         if (mouseButton == 0) {
            if (!this.field_1093) {
               this.method_1744();
            }
      ...
      if (this.field_1093) {
         int var4 = this.method_1749();
         int var5 = Math.round(this.h + this.d() + 1.0F);
         int var6 = this.method_1748();
         int var8 = var5 + 14;
         int var9 = var8 + 2;
         int var10 = var9 + 72;
         int var11 = var10 + 2;
         int var12 = var11 + 14;
         if (mouseButton == 0 && this.method_1753(mouseX, mouseY, var4, var5, var4 + var6, var8)) {
            this.field_1094 = true;
            this.f();
         } else {
            List var13 = this.method_1746();
            int var14 = this.method_1747();
            int var15 = var14 * 4;
            int var16 = Math.max(1, (int)Math.ceil((double)var13.size() / Math.max(1, var15)));
            this.field_1096 = Math.max(0, Math.min(this.field_1096, var16 - 1));
            int var17 = this.field_1096 * var15;
            ...
            for (int var19 = var17; var19 < var18; var19++) {
               ...
               if (mouseButton == 0 && this.method_1753(mouseX, mouseY, var23, var24, var25, var26)) {
                  this.field_1092.method_712((Item)var13.get(var19));
                  this.f();
                  return;
               }
            }
            ...
            if (mouseButton == 0 && this.method_1753(mouseX, mouseY, var28, var11 + 1, var29, var12 - 1)) {
               this.field_1096 = Math.max(0, this.field_1096 - 1);
               this.f();
            } else if (mouseButton == 0 && this.method_1753(mouseX, mouseY, var30, var11 + 1, var31, var12 - 1)) {
               this.field_1096 = Math.min(var16 - 1, this.field_1096 + 1);
               this.f();
            }
         }
      }
   ...
   public void method_1705(char typedChar, int keyCode) {
      if (this.field_1093 && this.field_1094 && this.method_1752(typedChar)) {
         this.field_1095 = this.field_1095 + Character.toLowerCase(typedChar);
         this.field_1096 = 0;
      }
   }
      ...
      if (this.field_1093) {
         switch (key) {
            ...
            default:
               return;
            case 259:
               if (this.field_1094 && !this.field_1095.isEmpty()) {
                  this.field_1095 = this.field_1095.substring(0, this.field_1095.length() - 1);
                  this.field_1096 = 0;
                  return;
               }
   ...
   public void method_1704() {
      this.a(!this.field_1092.n());
   }

   // $VF: renamed from: b () int
   @Override
   public int method_1711() {
      return !this.field_1093 ? this.d() : this.d() + 1 + 14 + 2 + 72 + 2 + 14 + 2;
   }

   // $VF: renamed from: c () int
   @Override
   public int method_1718() {
      return Dev.ZWare.Client.pkg1.pkg2.Class1.method_132(this.field_1092.a() + " " + Formatting.field_1080 + this.method_1750()) + 20;
   }
   ...
   public boolean method_1717(int mouseX, int mouseY) {
      ...
      if (this.method_1743(mouseX, mouseY)) {
         return true;
      } else if (!this.field_1093) {
         return false;
      } else {
         int var7 = this.method_1749();
         int var8 = Math.round(this.h + this.d() + 1.0F);
         int var5 = var7 + this.method_1748();
         int var6 = var8 + 14 + 2 + 72 + 2 + 14 + 2;
         return this.method_1753(mouseX, mouseY, var7, var8, var5, var6);
      }
   }
   ...
   private boolean method_1743(int var1, int var2) {
      return this.a(var1, var2, this.a(), this.b(), this.a() + this.a(), this.b() + this.d());
   }

   // $VF: renamed from: g () void
   private void method_1744() {
      this.field_1093 = true;
      this.field_1094 = false;
      this.field_1096 = 0;
   }

   // $VF: renamed from: h () void
   private void method_1745() {
      this.field_1093 = false;
      this.field_1094 = false;
      this.field_1096 = 0;
      this.field_1097 = null;
   }
   ...
   private List<Item> method_1746() {
      if (this.field_1095.isEmpty()) {
         return field_1091;
      } else {
         String var1 = this.field_1095.toLowerCase(Locale.ROOT);
         ArrayList var2 = new ArrayList();

         for (Item var4 : field_1091) {
            String var5 = this.method_1751(var4).toLowerCase(Locale.ROOT);
            String var6 = var4.method_63680().getString().toLowerCase(Locale.ROOT);
   ...
   private int method_1747() {
      return Math.max(4, (this.method_1748() - 4) / 18);
   }

   // $VF: renamed from: k () int
   private int method_1748() {
      return Math.max(this.a(), 76);
   }

   // $VF: renamed from: l () int
   private int method_1749() {
      return Math.round(this.g + ((float)this.a() - this.method_1748()) / 2.0F);
   }

   // $VF: renamed from: b () java.lang.String
   private String method_1750() {
      int var1 = ((Set)this.field_1092.a()).size();
      if (var1 == 0) {
         return "None";
      } else {
         Item var2 = (Item)((Set)this.field_1092.a()).iterator().next();
         return var1 == 1 ? this.method_1751(var2) : this.method_1751(var2) + " +" + (var1 - 1);
      }
   }

   // $VF: renamed from: a (net.minecraft.item.Item) java.lang.String
   private String method_1751(Item var1) {
      if (var1 == null) {
         return "air";
      } else {
         ...
         if (var2 != null) {
            ...
            return var1.method_63680().getString();
         }
      }
   }

   // $VF: renamed from: a (char) boolean
   private boolean method_1752(char var1) {
      return Character.isLetterOrDigit(var1) || var1 == '_' || var1 == ':' || var1 == '/' || var1 == '.';
   }

   // $VF: renamed from: a (int, int, int, int, int, int) boolean
   private boolean method_1753(int var1, int var2, int var3, int var4, int var5, int var6) {
      return var1 >= var3 && var1 <= var5 && var2 >= var4 && var2 <= var6;
   }

   // $VF: renamed from: c () java.util.List
   private static List<Item> method_1754() {
      ArrayList var0 = new ArrayList();
      Registries.field_41178.forEach(var1 -> {
         if (var1 != Items.field_8162) {
            var0.add(var1);
         }
      });
